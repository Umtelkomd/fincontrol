// Get all unique categories from transactions + bankMovements + budgets
...
async function main() {
  ...
  // Get unique categories from transactions (Firebase live data)
  ...
  console.log('=== TRANSACTION CATEGORIES (Firebase) ===');
