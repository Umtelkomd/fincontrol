...
const Gastos = ({ userRole, user, onNewTransaction }) => {
    ...
    return (
      <div className="flex items-center justify-center py-28">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-[#6b7a96]">Consolidando gastos operativos...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-12">
      <section className="rounded-[34px] border border-[rgba(205,219,243,0.82)] bg-[radial-gradient(circle_at_top_left,rgba(255,159,10,0.18),transparent_28%),linear-gradient(160deg,#17110b_0%,#090b10_100%)] px-6 py-7 shadow-[0_40px_120px_rgba(0,0,0,0.42)]">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.24em] text-[#ffc773]">Gastos</p>
            <h2 className="text-[32px] font-semibold tracking-tight text-[#101938]">Pagos reales y deuda operativa sin mezclar con caja futura.</h2>
          ...
          {canAct && onNewTransaction && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-[#ff453a] px-4 py-3 text-sm font-semibold text-[#101938] transition-colors hover:bg-[#e63b31]"
            >
              <Plus size={16} />
              Nueva factura CXP
            </button>
      ...
      <section className="rounded-[28px] border border-[rgba(205,219,243,0.82)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(244,248,255,0.94))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.32)]">
        <div className="mb-4 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="relative w-full xl:max-w-sm">
            ...
            <input
              className="w-full rounded-2xl border border-[rgba(205,219,243,0.82)] bg-[#101115] py-3 pl-10 pr-4 text-sm text-[#101938] outline-none transition-all focus:border-[rgba(255,159,10,0.35)]"
                          ...
                          {canSettle && (
                            <>
                              ...
                              <button
                                ...
                                className="rounded-xl bg-[#ff453a] px-3 py-2 text-xs font-semibold text-[#101938] transition-colors hover:bg-[#e63b31] disabled:opacity-50"
                              >
